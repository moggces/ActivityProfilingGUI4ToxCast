...
* apply flag (from curve fitting) filter: ON to label hits which mayhave fitting issues (NB: **AllResults_flags** and **spid_Matrix** were used). When OFF, hits with flags will have  **#** in the cells
